        ...
        <>
            ...
            <div className={styles.btnContainer}>
                ...
                <button className={`${styles.btn} ${styles.addBtn}`} 
                        ...
                        style={{
                            height: 35, fontWeight: "bold", 
                            border: showImageForm ? '3px solid red' : '3px solid blue',
                            backgroundColor: showImageForm ? 'rgba(255,19,0,.1)' : 'rgba(0,119,255,.1)',
                            color: showImageForm ? 'red' : 'blue'
                    }}>
            ...
            <div style={{textAlign:"center"}}>
                ...
                <h1 style={{color: 'black'}}>{imageList.length !== 0 ?"Your Collection":"No Images in Your Collection"}</h1>
            </div>
